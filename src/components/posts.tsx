...
export function Posts({ posts }: PostsProps) {
  ...
  return (
    <>
      {isSearching && (
        <div className="fixed bottom-4 left-4 right-4 max-w-2xl mx-auto bg-white/90 dark:bg-black/50 backdrop-blur-sm border border-gray-300 dark:border-gray-800 p-2">
